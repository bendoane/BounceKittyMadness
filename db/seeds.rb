...
Beer.create(name:"Mound Builder", brewery:"People's", location:"Lafayette, IN", style:"American IPA", ABV:"6.5")
Beer.create(name:"60 Minute IPA", brewery:"Dogfish Head", location:"Milton, DE", style:"American IPA", ABV:"6.0", local_beer:false)
Beer.create(name:"Stone IPA", brewery:"Stone", location:"Escondido, CA", style:"American IPA", ABV:"6.9", local_beer:false)
Beer.create(name:"Confessional", brewery:"St. Joseph", location:"Indianapolis, IN", style:"American IPA", ABV:"6.3")
Beer.create(name:"Buffalo Jacket IPA", brewery:"Outliers", location:"Indianapolis, IN", style:"American IPA", ABV:"6.8")
Beer.create(name:"Diabolical", brewery:"North Peak", location:"Traverse City, MI", style:"American IPA", ABV:"6.6", local_beer:false)
